...
public class Go121CustomUserStoreManagerV2 extends JDBCUserStoreManager {
	private static Log log = LogFactory.getLog(Go121CustomUserStoreManagerV2.class);
	public Go121CustomUserStoreManagerV2() {
	}
	public Go121CustomUserStoreManagerV2(org.wso2.carbon.user.api.RealmConfiguration realmConfig,
...
//					JDBCRealmConstants.GET_PROPS_FOR_PROFILE);
			sqlStmt = "SELECT ID, createdDate, modifiedDate  FROM go121Identity WHERE userName=?";
...
//		return true;
	...
	public Properties getDefaultUserStoreProperties(){
		...
		properties.setMandatoryProperties(G0121CustomUserStoreManagerConstantsV2.CUSTOM_UM_MANDATORY_PROPERTIES.toArray
				(new Property[G0121CustomUserStoreManagerConstantsV2.CUSTOM_UM_MANDATORY_PROPERTIES.size()]));
		properties.setOptionalProperties(G0121CustomUserStoreManagerConstantsV2.CUSTOM_UM_OPTIONAL_PROPERTIES.toArray
				(new Property[G0121CustomUserStoreManagerConstantsV2.CUSTOM_UM_OPTIONAL_PROPERTIES.size()]));
		properties.setAdvancedProperties(G0121CustomUserStoreManagerConstantsV2.CUSTOM_UM_ADVANCED_PROPERTIES.toArray
				(new Property[G0121CustomUserStoreManagerConstantsV2.CUSTOM_UM_ADVANCED_PROPERTIES.size()]));
