...
@Service
public class SimCardInfoWebService {
    ...
    public String backendService(HttpEntity<SimCardInfoRequestMdl> entity, String smsURL)  {
        ResponseEntity<String> responseEntity = null;
        try {
            responseEntity =  restTemplate.postForEntity(smsURL,entity,String.class);
