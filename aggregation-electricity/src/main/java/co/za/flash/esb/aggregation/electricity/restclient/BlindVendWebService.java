...
import co.za.flash.esb.aggregation.electricity.model.response.OBElecBlindVendResponse;
...
@Service
public class BlindVendWebService {
    ...
    public String backendService(HttpEntity<ElectricityRequestMdl> entity, String environment, LoggingPayloadMdl loggingPayloadMdl)  {
        ...
        OBElecBlindVendResponse obElecResponse = new OBElecBlindVendResponse();
