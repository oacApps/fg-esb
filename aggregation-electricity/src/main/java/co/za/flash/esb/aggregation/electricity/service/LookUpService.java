...
import co.za.flash.esb.aggregation.electricity.mapper.LookUpRequestMapper;
...
import co.za.flash.esb.aggregation.electricity.model.response.LookUpResponseMdl;
...
import co.za.flash.esb.aggregation.electricity.restclient.LookUpWebService;
    ...
    public Object service(Map<String, String> headers, LookupRequestDTO lookupRequestDTO, boolean isTest) {
        ...
        try {
            ...
            if (headers.containsKey(wso2JwtKeys.xJwtAssertion)) {
                ...
                // rest of the code
                ElectricityRequestMdl electricityRequestMdl = LookUpRequestMapper.INSTANCE.toMdl(lookupRequestDTO);
