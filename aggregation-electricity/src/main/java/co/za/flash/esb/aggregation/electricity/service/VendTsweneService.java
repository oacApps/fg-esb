...
import co.za.flash.esb.aggregation.electricity.model.response.VendTshwaneResponseMdl;
...
@Service
public class VendTsweneService {
    ...
    public Object service(Map<String, String> headers, ElectricityRequestDTO electricityRequestDTO, boolean isTest) {
        ...
        VendTshwaneResponseMdl responseMdl = new VendTshwaneResponseMdl();
        ...
        try {
            ...
            if (headers.containsKey(wso2JwtKeys.xJwtAssertion)) {
                ...
                try{
                    Gson gson = new Gson();
                    responseMdl = gson.fromJson(bkResponse, VendTshwaneResponseMdl.class);
