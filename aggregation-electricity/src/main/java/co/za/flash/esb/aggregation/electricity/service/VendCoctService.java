...
public class VendCoctService {
    ...
    public Object service(Map<String, String> headers, ElectricityRequestDTO electricityRequestDTO, boolean isTest) {
        ...
        VendCoctResponseMdl responseMdl = new VendCoctResponseMdl();
        ...
        try {
            ...
            if (headers.containsKey(wso2JwtKeys.xJwtAssertion)) {
                ...
                try{
                    Gson gson = new Gson();
                    responseMdl = gson.fromJson(bkResponse, VendCoctResponseMdl.class);

                    if(null == responseMdl.getOBElecResponse()){
                        OneBalance oneBalance = gson.fromJson(bkResponse, OneBalance.class);
                        /*OBElecCoctResponse obElecResponse = OneBalanceResponseMapper.INSTANCE.toOBElecCoctResponse(oneBalance.getOneBalance());
