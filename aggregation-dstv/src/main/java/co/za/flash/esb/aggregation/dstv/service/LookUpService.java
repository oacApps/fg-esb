...
import co.za.flash.esb.aggregation.dstv.mapper.LookUpRequestMapper;
import co.za.flash.esb.aggregation.dstv.mapper.OneBalanceResponseMapper;
import co.za.flash.esb.aggregation.dstv.model.*;
import co.za.flash.esb.aggregation.dstv.restclient.LookUpWebService;
    ...
    public Object service(Map<String, String> headers, LookUpRequestDTO lookUpRequestDTO, boolean isTest) {
        ...
        try {
            ...
            if (headers.containsKey(wso2JwtKeys.xJwtAssertion)) {
                ...
                // rest of the code
                DSTVRequestMdl dstvRequestMdl = LookUpRequestMapper.INSTANCE.toLookUpMdl(lookUpRequestDTO);
                ...
                try{
                    ...
                    if(null == responseMdl.getOBBillPaymentResponse()){
                       ...
                       /* OBBillPaymentResponse obBillPaymentResponse = OneBalanceResponseMapper.INSTANCE.toOBBillPaymentResponse(oneBalance.getOneBalance());
                        obBillPaymentResponse.setAccountNumber(Long.parseLong(dstvRequestMdl.getAcc_num()));
